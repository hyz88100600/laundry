...
public class PublishSMSMessageUtils {

	public static void publish(String phone,String smsCode){
        ...
        batchSmsAttributes.setFreeSignName("我爱洗衣");
        // 3.2 设置发送短信使用的模板（SMSTempateCode）
        batchSmsAttributes.setTemplateCode("SMS_70160314");
        // 3.3 设置发送短信所使用的模板中参数对应的值（在短信模板中定义的，没有可以不用设置）
        BatchSmsAttributes.SmsReceiverParams smsReceiverParams = new BatchSmsAttributes.SmsReceiverParams();
        smsReceiverParams.setParam("name", phone);
